...
// import { createBill, getBills } from '../features/bills/billSlice';
...
//     }
//   return (
//     <form onSubmit={handleSubmit} class="p-20 sm:ml-64 relative overflow-x-auto sm:rounded-lg">
//     <div class="relative z-0 w-full mb-5 group">
//     <label for="categories" class="block mb-2 text-sm font-medium text-gray-500 dark:text-white">Category</label>
//     <select id="categories" value={category} onChange={e => setCategory(e.target.value)} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
//     </div>
//     <div class="relative z-0 w-full mb-5 group">
//         <input type="text" name="floating_description" id="floating_description" onChange={e => setDescription(e.target.value)} class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
//         <div class="relative z-0 w-full mb-5 group">
//             <input type="number" name="floating_amount" id="floating_amount" min="0" onChange={e => setAmount(e.target.value)} class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
//         </div>
//         <div class="relative z-0 w-full mb-5 group">
//             <input type="date" name="floating_date" id="floating_date" onChange={e => setDate(e.target.value)} class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
