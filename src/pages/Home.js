...
//             <div class="p-6 bg-red-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">

//                 <h5 class="mb-2 text-2xl font-bold tracking-tight text-red-500 dark:text-white">Total Amount</h5>
//                 <p class="font-normal text-xl text-red-800 dark:text-gray-400">8000</p>
//             </div>

//             <div class="p-6 bg-green-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">

//                 <h5 class="mb-2 text-2xl font-bold tracking-tight text-green-500 dark:text-white">Bills to Pay</h5>
//                 <p class="font-normal text-xl text-green-800 dark:text-gray-400">3</p>
//             </div>
//         </div>
        
        
//         <table class="w-full my-6 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
