...
//     // Calculate bills to pay without exceeding the monthly budget
...
//                 selected.push(bill.id); // Add bill ID to selected list
//             } else {
//                 break;
//             }
//         }
...
//                         ${bills.reduce((acc, bill) => acc + Number(bill.amount), 0).toFixed(2)}
//                     </p>
//                 </div>
...
//                     ) : bills.length === 0 ? (
//                         <tr>
//                             <td colSpan="4" className="text-center py-4">No bills found</td>
//                         </tr>
//                     ) : (
//                         bills.map((bill) => (
//                             <tr
...
//                                     selectedBills.includes(bill.id) ? 'bg-green-500' : ''
//                                 }`}
//                             >
//                                 <td className="px-6 py-4">{bill.description}</td>
//                                 <td className="px-6 py-4">{bill.category}</td>
            ...
            <div className="grid grid-cols-3 gap-2">
                ...
                <div className="p-6 bg-yellow-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <input
                        ...
                        value={budget} // Set input value to current monthly budget
